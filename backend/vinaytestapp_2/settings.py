"""
Django settings for vinaytestapp_2 project.
...
ROOT_URLCONF = 'vinaytestapp_2.urls'
...
WSGI_APPLICATION = 'vinaytestapp_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vinaytestapp_2 API",
    "DESCRIPTION": "API documentation for vinaytestapp_2 App",
    "VERSION": "v1",
}
